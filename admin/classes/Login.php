...
class Login
{
                ...
                if ($checklogin->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
                        ...
                        $this->user_is_logged_in = true;
                            ...
                            $query = "INSERT INTO registrousuario (usuario_registrousuario, ult_registrousuario) VALUES ('$usuario', NOW())";
                            $result=mysql_query($query,$link) or die(mysql_error()); /*ESTA ES UNA COMPROBACIÓN PARA LA CONEXIÓN CON LA BASE DE DATOS */
                        $usuario = $_SESSION['user_name'];
                    } else {
                        $this->errors[] ="Contraseña errónea, intente nuevamente";
                    }
                } else {
                    $this->errors[] ="Este usuario no existe, contacte al administrador.";
                }
            } else {
                $this->errors[] ="Problemas con la conexión de la base de datos.";
            }
    ...
    public function doLogout()
    {
        ...
        $this->messages[] ="Acabas de terminar sesión.";
