...
$c=1;
echo '<form name="tutoria" action="agregar_tutoria.php" method="POST" enctype="multipart/form-data">';
...
echo'Motivo de visita<textarea name="asunto" rows="5" cols="40" required="required"></textarea><br>'; 
...
echo'<br><input id="botonotro"  align="center" TYPE=SUBMIT VALUE="Guardar">';  
echo '<input id="botonregresar"  align="center" TYPE=RESET VALUE="Regresar" onclick="history.back()">';
echo'</form>';
