...
<!DOCTYPE html>
	...
	<article></article>
	<section>
			<h1 align="center"> Lista de Asesorados</h1><br>
			<div id="tutorados">
			<?php
	        ...
	        $query = mysql_query("SELECT * FROM alumno where id_asesor='$id_prof' && activo=1 order by nombre_alumno asc",$link);         
