					...
					<div class="card">
						<div class="card-content blue-grey-text text-darken-3">
							...
							<div class="row">
								...
								<div class="col l4 m6 s12">
									<div class="input-field">
										<input type="text" name="apellidop" class="validate" required>
										<label>Apellido paterno</label>
									</div>
								</div>
								<div class="col l4 m6 s12">
									<div class="input-field">
										<input type="text" name="apellidom" class="validate" required>
										<label>Apellido materno</label>
									</div>
								</div>
								<div class="col l4 m6 s12">
									<div class="input-field">
										<input type="text" name="tipo" class="validate" required>
										<label>Tipo amigo</label>
									</div>
								</div>
								<div class="col l4 m6 s12">
									<div class="input-field">
										<input type="text" name="tutor_amigo" class="validate" required>
										<label>Tutor amigo</label>
									</div>
								</div>
								<div class="col l4 m6 s12">
									<div class="input-field">
										<input type="number" name="amistadanios" class="validate" required>
										<label>Aimgos de amigos</label>
									</div>
								</div>
								...
								<div class="col l12 m12 s12">
									<div class="input-field">
											<textarea id="textarea1" name="opinion" class="materialize-textarea" rows="5" required=""></textarea>
										<label>Opinion</label>
									</div>
								</div>
							</div>
