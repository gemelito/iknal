...
<article></article>
<section>	
	<h1 align="center">Información del Alumno</h1><br>
...
<?php
	...
	if ($row = mysql_fetch_array($result2)){
		...
		echo ' Matricula <input type="text" readonly="readonly"  name="matricula" size="9" value='.$row["matricula_alumno"].'>'.'<br>';
			
		echo ' Nombre <input type="text" readonly="readonly" size="10" name="nombre" value="'.$row["nombre_alumno"].'">';
		echo ' <input type="text"   readonly="readonly" name="apellidop"  size="10" value="'.$row["apellidop_alumno"].'">';
		echo ' <input type="text"   readonly="readonly" name="apellidom"  size="10" value="'.$row["apellidom_alumno"].'">'.'<br>';
...
<div id="foto"> 
	                ...
	                while ($lista=mysql_fetch_array($resultado)){
	                	if ($lista['foto'] == 0){
	                		echo "<img src='../images/alumno/".$lista['foto'].".png' width='240' height='240' position='left'><br>";
	                	}else{
	                		echo "<img src='../images/alumno/".$lista['foto']."' width='240' height='240' position='left'><br>";	                		
	                	}
	                }
	            	?>
